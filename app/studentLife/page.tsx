  ...
  return(
    <section>
      ...
      <div className="mx-5 px-3">
        ...
        <p className="my-2 py-2 text-charcoal">S.5 and S.6 wear nevi blue trousers/skirts</p>
        <p className="my-2 py-2 text-charcoal">For certain days and co-curricular activities, students may wear the official school T-shirts.</p>
        <p className="my-2 py-2 text-charcoal">House T-shirts</p>
        <p className="my-2 py-2 text-charcoal">Sapphire T-shirts</p>
        <p className="my-2 py-2 text-charcoal">Club T-shirts</p>
        <p className="my-2 py-2 text-charcoal">All students here are provided with a grey school sweater for O-level and nevi blue school sweater for A-level, the students wear black, plain leather short heeled shoes only.  O-level boys wear grey striped socks and the girls wear plain white socks.
