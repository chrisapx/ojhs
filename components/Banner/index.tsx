    ...
    return (
        <div id="home-section" className='bg-lightkblue'>
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-16">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 gap-10'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        ...
                        <h1 className='text-[#2f66a6] text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0'>Welcome to Jericho High School.</h1>
                        ...
                        <div className='flex flex-col justify-between pt-10 lg:pt-4'>
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Results Based</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Goal Oriented</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Growth Centered</p>
                            </div>
                        </div>
                    </div>

                    <div className='col-span-6 flex justify-center'>
                        <Image src="/assets/building.jpg" alt="nothing" width={1000} height={805} className="rounded-[20px]" />
                    </div>
                </div>
            </div>
        </div>
